...
from aib_analysis.survey_analysis.loading import normalize_name
...
def generate_review_report(features: list[RespondentFeatures]) -> str:
    ...
    lines.append(
        ...
        "generated by `aib_analysis/survey_analysis/review_report.py` alongside the analysis, so it "
