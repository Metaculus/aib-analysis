...
def main():
    ...
    with tab8:
        ...
        display_tournament_and_variations(cup_vs_bot_teams, "Cup (All forecasters) vs Bot Teams")
        ...
        display_tournament_and_variations(cup_mvp_team_vs_bot_team, "Cup MVP Team vs Bot Teams")
